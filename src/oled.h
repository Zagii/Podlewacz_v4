  ...
  public:
    ...
    void begin()
    {
        ...
        { 
            ...
            delay(3000); // Don't proceed, loop forever
        }
...
void testanimate(const uint8_t *bitmap, uint8_t w, uint8_t h) {
 ...
 // display.startscrolldiagright(0x00, 0x07);
  ...
  { // Loop forever...
       ...
       if(i<30) display.setCursor(i, i);
       else display.setCursor(30+30-i, i);
        display.println(F("Podlewacz"));
        // Draw each snowflake:
        for(f=0; f< NUMFLAKES; f++) {
  ...
  void drawNetworkView()
  {
    ...
    display.setTextColor(WHITE);        // Draw white text
    display.setCursor(0,0);             // Start at top-left corner
    display.println(F("Podlewacz ver.:"));
    display.print(F("Wifi mode: "));
    ...
    switch(m)
    {
        ...
        break;
        case WIFI_STA:
        display.println(F("STA"));
        break;
        case WIFI_AP:
        display.println(F("AP"));
        break;
        case WIFI_AP_STA:
        display.println(F("AP_STA"));
        break;
    }
    display.print(F("SSID: "));display.println(WiFi.SSID());
    display.print(F("IP: "));display.println(WiFi.localIP().toString());
    display.display();  
  };
  void drawTimeView(unsigned long rtc,unsigned long ntp)
  {
      display.clearDisplay();
